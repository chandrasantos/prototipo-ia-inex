...
Esse repositório apresenta a versão 1 do protótipo criado pelos alunos Chandra dos Santos, Ennio Ennio Bernardo Pessoa dos Santos e Willian Rocha da Silva, na disciplina PROJETO INTEGRADOR DE CIÊNCIA DOS DADOS I-T01-2025-2, do curso de graduação em Ciência dos Dados da Universidade Federal do Mato Grosso do Sul (UFMS). O objetivo da ferramenta é atuar como um assistente de IA para a startup "INEX", ajudando usuários a encontrar oportunidades acadêmicas (mestrado, doutorado, extensão, por exemplo) no Brasil. 
